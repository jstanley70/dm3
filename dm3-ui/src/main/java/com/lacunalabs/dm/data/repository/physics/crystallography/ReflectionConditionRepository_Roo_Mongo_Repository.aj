...
privileged aspect ReflectionConditionRepository_Roo_Mongo_Repository {
    
    declare parents: ReflectionConditionRepository extends PagingAndSortingRepository<ReflectionCondition, BigInteger>;
    
    declare @type: ReflectionConditionRepository: @Repository;
