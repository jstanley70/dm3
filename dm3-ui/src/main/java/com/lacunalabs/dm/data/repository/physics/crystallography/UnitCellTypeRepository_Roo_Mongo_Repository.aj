...
privileged aspect UnitCellTypeRepository_Roo_Mongo_Repository {
    
    declare parents: UnitCellTypeRepository extends PagingAndSortingRepository<UnitCellType, BigInteger>;
    
    declare @type: UnitCellTypeRepository: @Repository;
